...
SystemePlanetaire& SystemePlanetaire::operator=(const SystemePlanetaire &autreSysteme) {
    if (this != &autreSysteme) {
        delete[] this->_planetes;
