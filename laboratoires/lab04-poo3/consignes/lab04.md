...
Voici la définition et l'implémentation d'une classe `TemperatureDatapoint` à ajouter à votre programme. Cette classe permet de représenter une lecture de température à un moment précis dans le temps.

**Fichier `TemperatureDatapoint.h`**
...
**Fichier `TemperatureDatapoint.cpp`**
...
**Fichier `TemperatureHistory.cpp`**
...
Et voici finalement le code à inclure dans le `main`:
